...
#endif
		PVR_DPF((PVR_DBG_ERROR, "NOTE: Enabling DEBUG_BRIDGE_KM_DISPATCH_TABLE may help debug this issue. in %s",
				__FUNCTION__));
	}
					  ...
					  PVRSRV_BRIDGE_PACKAGE   * psBridgePackageKM)
{
	...
	{
		PVR_DPF((PVR_DBG_ERROR, "%s: ui32BridgeID = %u is out if range!",
				 __FUNCTION__, (unsigned int)ui32BridgeID));
		goto return_fault;
	}
	pfBridgeHandler =
