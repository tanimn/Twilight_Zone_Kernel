							   ...
							   RESMAN_FREE_FN	pfnFreeResource)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManRegisterRes: register resource "
			...
			"FreeFunc %p",
			psResManContext, (unsigned int)ui32ResType, pvParam,
			(unsigned int)ui32Param, pfnFreeResource));
...
PVRSRV_ERROR ResManFreeResByPtr(RESMAN_ITEM	*psResItem)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManFreeResByPtr: freeing resource at %p", psResItem));
									 ...
									 IMG_UINT32			ui32Param)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE, "ResManFreeResByCriteria: "
			...
			psResManContext, (unsigned int)ui32SearchCriteria, (unsigned int)ui32ResType,
			pvParam, (unsigned int)ui32Param));
												  ...
												  RESMAN_ITEM		*psItem)
{
	...
	PVR_DPF((PVR_DBG_MESSAGE,
			...
			psResManContext,
			(unsigned int)psItem->ui32ResType, psItem->pvParam, (unsigned int)psItem->ui32Param,
			psItem->pfnFreeResource, (unsigned int)psItem->ui32Flags));
