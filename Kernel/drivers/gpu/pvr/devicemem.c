												...
												PVRSRV_KERNEL_SYNC_INFO		**ppsKernelSyncInfo)
{
	...
	psSyncData->dummy1[0] = 0xdeadcafe;
	psSyncData->dummy1[1] = 0xdeadcafe;
	psSyncData->dummy1[2] = 0xdeadcafe;
	psSyncData->dummy1[3] = 0xdeadcafe;
	psSyncData->dummy1[4] = 0xdeadcafe;
	...
	psSyncData->dummy2[0] = 0xdeadcafe;
	psSyncData->dummy2[1] = 0xdeadcafe;
	psSyncData->dummy2[2] = 0xdeadcafe;
	psSyncData->dummy2[3] = 0xdeadcafe;
	psSyncData->dummy2[4] = 0xdeadcafe;
