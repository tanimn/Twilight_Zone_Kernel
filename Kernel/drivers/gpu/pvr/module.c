...
#if 0 //defined(SLSI_S5PC110) && defined(CONFIG_HAS_EARLYSUSPEND)
	s5pc110_g3d_early_suspend.suspend = (void*)PVRSRVDriverSuspend;
	s5pc110_g3d_early_suspend.resume = (void*)PVRSRVDriverResume;
//	s3c_dev->early_suspend.level = EARLY_SUSPEND_LEVEL_DISABLE_FB;
	register_early_suspend(&s5pc110_g3d_early_suspend);
#endif
...
#if 0 //defined(SLSI_S5PC110) && defined(CONFIG_HAS_EARLYSUSPEND)
        unregister_early_suspend(&s5pc110_g3d_early_suspend);
#endif
...
#endif
{
	...
	PVR_TRACE(("PVRSRVDriverResume(pDevice=%p)", pDevice));
        ...
        //printk("\n===3D resume: ");
/*zepplin 2010.03.10  */
#if 1 // zepplin 2010.03.10_BEGIN
	if (PVRSRVSetPowerStateKM(PVRSRV_SYS_POWER_STATE_D0) != PVRSRV_OK)
	{
	        //printk("powered on failed\n");
		return -EINVAL;
	}
        //printk("powered on\n ");       
#endif // zepplin 2010.03.10_END
#endif
	return 0;
}
#endif 
...
#endif
        PVR_DPF((PVR_DBG_MESSAGE, "PVRCore_Init: major device %d", AssignedMajorNumber));
